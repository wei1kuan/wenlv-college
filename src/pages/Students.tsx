...
import { studentNews } from '@/data/mockData';
...
export default function Students() {
  ...
  const [activeTab, setActiveTab] = useState(() => {
    ...
    return hashTabMap[hash] || 'activities';
  });
  ...
  const tabs = [
    { key: 'activities', label: '学生活动', items: studentNews.activities },
    { key: 'clubs', label: '社团风采', items: studentNews.clubs },
    { key: 'awards', label: '获奖荣誉', items: studentNews.awards },
  ];
