...
const courses = [
  { name: "酒店管理概论", desc: "酒店业基础理论与运营模式", icon: "🏨" },
  { name: "前厅与客房管理", desc: "前厅接待与客房运营实务", icon: "🛎️" },
  { name: "餐饮服务与管理", desc: "餐饮运营与服务质量管理", icon: "🍽️" },
  { name: "酒店市场营销", desc: "酒店产品营销与品牌推广", icon: "📈" },
  { name: "人力资源管理", desc: "酒店人力资源配置与管理", icon: "👥" },
  { name: "财务管理", desc: "酒店财务核算与成本控制", icon: "💰" },
  { name: "数字化运营", desc: "酒店数字化管理系统应用", icon: "🖥️" },
  { name: "酒店英语", desc: "酒店行业英语沟通能力", icon: "🗣️" },
];
...
export default function HotelManagement() {
  ...
  const items = majorNews["hotel-management"];
  return (
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 bg-white rounded-xl shadow-sm border border-heritage-gold/10 p-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-gray-700 leading-relaxed text-base">
              <div><p>酒店管理与数字化运营专业培养掌握现代酒店管理理论和数字化运营技能的专业人才，紧跟行业数字化转型趋势。</p></div>
              <div><p>学生将学习酒店管理概论、前厅与客房管理、餐饮服务与管理、数字化运营等核心课程，通过校内实训和校外实习积累经验。</p></div>
              <div><p>毕业生可在星级酒店、度假村、连锁酒店集团、高端餐饮企业、在线旅游平台等单位从事管理运营工作。</p></div>
            </div>
          </div>
          <div className="mt-12">
            <SectionTitle title="核心课程" subtitle="管理+技术，全面培养" />
