...
import { partyNews } from '@/data/mockData';

type ViewMode = 'card' | 'list';

const hashTabMap: Record<string, string> = {
  'general-branch': 'overview',
  'party-dynamics': 'dynamics',
};
...
export default function Party() {
  ...
  const [activeTab, setActiveTab] = useState(() => {
    ...
    return hashTabMap[hash] || 'overview';
  });
  ...
  const tabs = [
    { key: 'overview', label: '总支概况', items: partyNews.overview },
    { key: 'dynamics', label: '党建动态', items: partyNews.dynamics },
  ];
