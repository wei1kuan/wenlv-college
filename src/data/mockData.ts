...
export const recruitNews = [
  {
    id: 1,
    title: "2024年文旅创意学院招生简章发布",
    summary: "我院2024年招生计划已公布，共计划招收各类专业学生500余人...",
    date: "2024-06-01",
    tag: "重要通知",
  ...
  },
  {
    id: 2,
    title: "湖北省技能高考报名开始",
    summary: "2024年湖北省技能高考报名工作已启动，请符合条件的考生按时报名...",
    date: "2024-05-20",
    tag: "报名信息",
  ...
  },
  {
    id: 6,
    title: "单招考试时间安排",
    summary: "2024年单独招生考试时间已确定，请考生做好准备...",
    date: "2024-04-28",
    tag: "考试安排",
...
export const introData = {
  title: "文旅创意学院",
  subtitle: "传承文化 创意未来",
  description: `文旅创意学院致力于培养具有深厚文化底蕴和创新设计能力的高素质人才。学院以荆楚文化为根基，融合现代设计理念，开设非遗传承、文创设计、数字媒体等专业方向。

学院拥有先进的实训设施和丰富的行业资源，与多家文化机构和企业建立合作关系，为学生提供实践平台。我们秉承"传承不守旧，创新不忘本"的理念，培养能够将传统文化与现代创意完美融合的新时代人才。`,
